# setwd("/Users/jacobherbstman/Desktop/homebuilder_10ks/tasks/source_registry/code")
...
checks <- tibble(
  table_name = c("source_catalog", "manual_manifest"),
  ...
  row_count = c(nrow(source_catalog), nrow(manual_manifest))
)
